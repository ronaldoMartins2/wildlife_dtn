...
def run( first_animal, second_animal, file_rawdata_name ):
    ...
    distanceGoal = 10
    # número de linhas des registros dos dados brutos
    ...
    file_path = os.path.join(results_dir, f'contact_{first_animal}_{second_animal}.csv')
            ...
            with open(second) as csv_file_second :
                ...
                for row_2 in csv_reader_second :
                    ...
                    if '.' in  row_2[3] and '.' in row_2[2]:
                        coords_2 = (row_2[3], row_2[2])
                        # print(f' row_2[2] {row_2[2]} row_2[3] {row_2[3]}')
                    else:
                        continue
                    
                    # calcula a diferença entre o tempo corrente do primeiro animal e o tempo inicial
                    difference = timeFirst - firstTimeEven
                    difference_in_s = difference.total_seconds()
                    
                    # transforma a diferença de segundos para minutos
