...
def run(current_animal, file_rawdata_name):
    ...
    plt.title(f"Histograma dos Gaps entre Registros - Jaguar {current_animal} - Dados Brutos")
    #plt.title(f"Histogram of Gaps between Records - Jaguar {current_animal} - N-BEATS")
